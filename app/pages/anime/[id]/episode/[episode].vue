...
useSeoMeta({
  title: `${data.value?.title} - ${data.value.meta.animeTitle} Episode ${data.value.meta.episodeDisplay} | Anime Recap`,
...
<template>
  <div>
    ...
    <article v-else-if="data" class="max-w-4xl mx-auto">
      ...
      <div v-if="!data.meta.author" class="text-gray-500 dark:text-gray-400 italic mt-8">
